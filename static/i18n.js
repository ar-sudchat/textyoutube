...
(function (global) {
    ...
    const DICT = {
        en: {
            ...
            'options.videoType': 'Video type',
            'options.public': 'Public',
            'options.private': 'Private',
            'options.public.hint': 'Public or unlisted videos',
            'options.private.hint': 'Private videos — requires session cookies',
        ...
        th: {
            ...
            'options.videoType': 'ประเภทวิดีโอ',
            'options.public': 'สาธารณะ',
            'options.private': 'ส่วนตัว',
            'options.public.hint': 'วิดีโอสาธารณะหรือ Unlisted',
            'options.private.hint': 'วิดีโอส่วนตัว — ต้องใช้ Session Cookies',
        ...
        zh: {
            ...
            'options.videoType': '视频类型',
            'options.public': '公开',
            'options.private': '私享',
            'options.public.hint': '公开或不公开列出的视频',
            'options.private.hint': '私享视频 — 需要 Session Cookies',
        ...
        ja: {
            ...
            'options.videoType': '動画の種類',
            'options.public': '公開',
            'options.private': '非公開',
            'options.public.hint': '公開または限定公開の動画',
            'options.private.hint': '非公開の動画 — セッション Cookie が必要です',
